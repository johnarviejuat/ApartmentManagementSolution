        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantHistoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_TenantHistories_TenantHistoryId",
                        column: x => x.TenantHistoryId,
                        principalTable: "TenantHistories",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_TenantHistoryId",
                table: "Payments",
                column: "TenantHistoryId");
